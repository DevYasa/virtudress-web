...
import { Upload, Camera, BarChart2, AlertCircle } from 'lucide-react';
        ...
        {user.dashboardAccess ? (
          ...
          <div className="bg-[#1f0f47] rounded-lg shadow-md p-6 mb-8">
            <h2 className="text-2xl font-semibold mb-4 flex items-center">
              <AlertCircle className="mr-2 h-6 w-6 text-yellow-400" />
              Dashboard Access Restricted
            </h2>
            <p>
              Your dashboard access is currently disabled. Please contact an administrator to enable access to product management and statistics.
            </p>
          </div>
        )}
      </div>
